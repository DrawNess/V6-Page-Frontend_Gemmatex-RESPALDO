...
export class AdminSidebarComponent {
  ...
  readonly isGlobalAdmin  = this.tokenService.hasRole('admin');
  readonly hasBranchScope = !this.isGlobalAdmin &&
    (this.tokenService.hasRole('branch_admin') || this.tokenService.hasRole('seller'));
  ...
  readonly nav: NavSection[] = [
    ...
    },
    {
      ...
      visibleFor: ['admin', 'branch_admin', 'seller', 'staff'],
      items: [
